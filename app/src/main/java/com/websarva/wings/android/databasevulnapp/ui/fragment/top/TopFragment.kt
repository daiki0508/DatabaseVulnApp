...
class TopFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val items = listOf(getString(R.string.rvTitle1), getString(R.string.rvTitle2), getString(R.string.rvTitle3), getString(R.string.rvTitle4), getString(R.string.rvTitle5), getString(R.string.rvTitle6), getString(R.string.rvTitle7))
        // recyclerViewの作成
